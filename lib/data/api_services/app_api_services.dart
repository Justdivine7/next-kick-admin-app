...
class AppApiClient {
        ...
        onError: (e, handler) async {
          ...
          if (e.response?.statusCode == 401 &&
            ...
            try {
              ...
              await _localStorage.completeLogout();
            }
          }
          return handler.next(e);
        },
  ...
  Future<Response> apiCall({
    ...
    bool skipConnectivityCheck =
        false, // Allow bypassing check for critical requests
  }) async {
    ...
    try {
      ...
      final message = FriendlyError.getMessage(e);
      throw Exception(message);
    } catch (error, stack) {
      FriendlyError.logError(error, stack);
      final message = FriendlyError.getMessage(error);
      throw Exception(message);
    }
  }
